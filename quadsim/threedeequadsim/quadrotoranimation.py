...
class QuadrotorAnimation():
    ...
    def __init__(self):
        ...
        params = readparamfile('params-3dquad-default.txt')
        l_arm = params.l_arm
        D = params.D
        h = params.h
        ...
        self.circles = [self.Circle((l_arm, l_arm, h), D/2, (0., 0., l_arm)),
                        self.Circle((-l_arm, l_arm, h), D/2, (0., 0., l_arm)),
                        self.Circle((-l_arm, -l_arm, h), D/2, (0., 0., l_arm)),
                        self.Circle((l_arm, -l_arm, h), D/2, (0., 0., l_arm)),]
        self.fps = 30
        self.Rs = None 
