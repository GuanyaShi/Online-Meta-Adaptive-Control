...
DEFAULT_BASELINE_PARAM_FILE = 'params-baseline.json'
DEFAULT_DELAY_PARAM_FILE = 'params-delay-comp.json'
# DEFAULT_ADAPTIVE_CONSTANT_PARAM_FILE = 'params-adaptive-constant.json'
# DEFAULT_ADAPTIVE_LEARNED_PARAM_FILE = 'params-adaptive-learned.json'
DEFAULT_ADAPTIVE_PARAM_FILE = 'params-adaptive.json'
DEFAULT_PX4_PARAM_FILE = 'params-px4.json'
DEFAULT_QUAD_PARAMETER_FILE = 'params-quadrotor.json'
...
class Baseline(Controller):
    ...
    def __init__(self, ctrlparamfile=DEFAULT_BASELINE_PARAM_FILE, quadparamfile=DEFAULT_QUAD_PARAMETER_FILE, integral_control=True, **kwargs):
...
class DelayComp(Baseline):
    ''' Baseline controller with the delay compensation parameter file '''
    _name = 'delay-comp'
    name_long = 'Delay Compensation'
    def __init__(self, delayparamfile=DEFAULT_DELAY_PARAM_FILE, integral_control=True, **kwargs):
        super().__init__(integral_control=integral_control, **kwargs)
        self.params = readparamfile(filename=delayparamfile, params=self.params)


class MetaAdapt(DelayComp):
    _name = None
